...
The Vuhn Bitcoin Cash Node daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Vuhn Bitcoin Cash Node requires the ZeroMQ API >= 4.1.5
