...
It is possible to run Vuhn Bitcoin Cash Node as a Tor onion service, and connect to
such services.
...
## 1. Run Vuhn Bitcoin Cash Node behind a Tor proxy

The first step is running Vuhn Bitcoin Cash Node behind a Tor proxy. This will already
...
## 2. Run a Vuhn Bitcoin Cash Node hidden server
...
This new feature is enabled by default if Vuhn Bitcoin Cash Node is listening (`-listen`),
...
- Do not add anything but Vuhn Bitcoin Cash Node ports to the onion service created
  in section 2.
