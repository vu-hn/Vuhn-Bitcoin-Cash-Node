...
## Setting up an out-of-tree Ninja build of Vuhn Bitcoin Cash Node
...
- -DDOC_ONLINE=ON # Adapt Markdown and HTML documentation for publication on docs.vuhnbitcoincashnode.org
