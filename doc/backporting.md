...
The official guide to backporting code between Vuhn Bitcoin Cash Node and the Core or
...
Vuhn Bitcoin Cash Node despite consensus-level differences between Bitcoin Cash and
Bitcoin Core.
...
in the Vuhn Bitcoin Cash Node repository, fix bugs, and make future backports significantly
...
to your Vuhn Bitcoin Cash Node repo.
...
8. Commit and push the staged backport to a feature/fix branch on your clone of
   the Vuhn Bitcoin Cash Node repository.
