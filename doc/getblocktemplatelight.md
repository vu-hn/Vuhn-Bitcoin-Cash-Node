...
License: CC0-1.0
Comments-URI: https://github.com/vu-hn/Vuhn-Bitcoin-Cash-Node/-/merge_requests/284
...
NOTE: The first element of the Merkle path list will be a transaction hash
      ...
      on the size of the job id string, for example the Vuhn Bitcoin Cash Node
...
(2) The coinbase field has an enforced minimum size of 100 bytes.
    ...
    For example, in the Vuhn Bitcoin Cash Node software a maximum of 1000 bytes are
...
A C++ reference implementation is available in Vuhn Bitcoin Cash Node
[merge request 281](https://github.com/vu-hn/Vuhn-Bitcoin-Cash-Node/-/merge_requests/281).
...
This specification is based on an adaptation by Vuhn Bitcoin Cash Node of a
...
branch construction in the Vuhn Bitcoin Cash Node source code [4].
...
- [4] [src/rpc/mining.cpp](https://github.com/vu-hn/Vuhn-Bitcoin-Cash-Node/-/blob/master/src/rpc/mining.cpp?ref_type=heads#L1207), see `MakeMerkleBranch` function
